...
repository:
  ...
  url: "https://github.com/ashuangiras/platform-compliance"   # ashuangiras to be resolved
  type: platform-repo
...
## Outstanding
- `ashuangiras` placeholder — needs to be replaced with the actual GitHub org name
